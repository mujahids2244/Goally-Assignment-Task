...
import com.android.goally.ui.copilot.CopilotActivity
    ...
    private fun setupViews() {
        binding.run {
            llCopilot.setSafeOnClickListener {
                startActivity(CopilotActivity.getCallingIntent(this@HomeActivity))
            }
    ...
    private fun setupObservers() {
        ...
        generalViewModel.getAuthenticationLive().observe(this) {
            it?.let {
                ...
                preferenceUtil.saveString("token",it.token ?: "")
//                passToken(it.token ?: "")
            }
        }
    }
