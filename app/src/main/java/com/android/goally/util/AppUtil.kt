...
import com.android.goally.data.model.api.response.copilot.CombinedChecklistRoutine
...
object AppUtil {
    ...
    fun showAlert(context: Context) {
        ...
        val customView = inflater.inflate(R.layout.ic_no_net, null)
